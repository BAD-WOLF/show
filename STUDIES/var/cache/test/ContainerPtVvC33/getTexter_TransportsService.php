...
class getTexter_TransportsService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['texter.transports'] = ($container->privates['texter.transport_factory'] ?? $container->load('getTexter_TransportFactoryService'))->fromStrings(['sendgrid' => $container->getEnv('MAILER_DSN')]);
    }
}
