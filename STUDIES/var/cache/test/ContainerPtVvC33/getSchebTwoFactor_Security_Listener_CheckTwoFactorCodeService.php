 ...
 */
class getSchebTwoFactor_Security_Listener_CheckTwoFactorCodeService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['scheb_two_factor.security.listener.check_two_factor_code'] = new \Scheb\TwoFactorBundle\Security\Http\EventListener\CheckTwoFactorCodeListener(($container->privates['scheb_two_factor.provider_preparation_recorder'] ?? $container->load('getSchebTwoFactor_ProviderPreparationRecorderService')), ($container->privates['scheb_two_factor.provider_registry'] ?? $container->load('getSchebTwoFactor_ProviderRegistryService')));
    }
}
