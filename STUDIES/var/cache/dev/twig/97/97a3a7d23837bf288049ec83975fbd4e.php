...
class __TwigTemplate_6a6d1d9a8a4ada373d0db9e6cdd8a3e6 extends Template
{
    private $source;
    private $macros = [];
...
", "@Security/Collector/icon.svg", "/data/data/com.termux/files/home/STUDIES/vendor/symfony/security-bundle/Resources/views/Collector/icon.svg");
    }
}
